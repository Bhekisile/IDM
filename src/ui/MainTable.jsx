...
//     return (
//       <table className="table-fixed border border-stone-800 overflow-auto mx-6 px-6 text-stone-300">
//         <thead className="">
//           <tr className="border border-stone-800 h-[40px]">
//             <th className="cell-width"><input type="checkbox" /></th>
//             <th className="flex items-center h-[40px]">Name:</th>
//             <th>Size:</th>
//           </tr>
//         </thead>
...
//               </td>
//               <td className="pl-4 flex items-center h-[40px] md:gap-4 sm:gap-2">{name}</td>
